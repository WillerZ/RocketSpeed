...
public:
    ...
    virtual PublishStatus Publish(int16_t namespace_id, std::string topic_name, RetentionBase retention, std::vector<uint8_t> data, std::experimental::optional<MsgIdImpl> message_id, std::shared_ptr<PublishCallbackImpl> publish_callback) = 0;

    virtual void ListenTopics(std::vector<SubscriptionRequestImpl> names) = 0;

    virtual void Acknowledge(int16_t namespace_id, std::string topic_name, int64_t sequence_number) = 0;
