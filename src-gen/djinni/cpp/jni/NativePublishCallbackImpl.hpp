...
public:
    ...
    const jmethodID method_Call { djinni::jniGetMethodID(clazz.get(), "Call", "(Lorg/rocketspeed/Status;Ljava/lang/String;Ljava/lang/String;Lorg/rocketspeed/MsgIdImpl;J)V") };

    class JavaProxy final : djinni::JavaProxyCacheEntry, public ::rocketspeed::djinni::PublishCallbackImpl {
    public:
        JavaProxy(jobject obj);
        virtual void Call(::rocketspeed::djinni::Status status, std::string namespace_id, std::string topic_name, ::rocketspeed::djinni::MsgIdImpl message_id, int64_t sequence_number) override;
