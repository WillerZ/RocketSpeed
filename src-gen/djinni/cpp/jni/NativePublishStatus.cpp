...
#include "src-gen/djinni/cpp/jni/NativePublishStatus.hpp"  // my header
...
jobject NativePublishStatus::toJava(JNIEnv* jniEnv, ::rocketspeed::djinni::PublishStatus c) {
    ...
    djinni::LocalRef<jobject> j_message_id(jniEnv, ::djinni::HOptional<std::experimental::optional, NativeMsgIdImpl>::toJava(jniEnv, c.message_id));
...
::rocketspeed::djinni::PublishStatus NativePublishStatus::fromJava(JNIEnv* jniEnv, jobject j) {
    ...
    return ::rocketspeed::djinni::PublishStatus(
        ...
        ::djinni::HOptional<std::experimental::optional, NativeMsgIdImpl>::fromJava(jniEnv, djinni::LocalRef<jobject>(jniEnv, jniEnv->GetObjectField(j, data.field_messageId)).get()));
}
