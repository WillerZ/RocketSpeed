...
void NativeReceiveCallbackImpl::JavaProxy::JavaProxy::Call(int32_t c_namespace_id, std::string c_topic_name, int64_t c_sequence_number, std::vector<uint8_t> c_contents) {
