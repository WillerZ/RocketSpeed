...
public:
    ...
    const jmethodID method_Call { djinni::jniGetMethodID(clazz.get(), "Call", "(Ljava/lang/String;Ljava/lang/String;J[B)V") };

    class JavaProxy final : djinni::JavaProxyCacheEntry, public ::rocketspeed::djinni::ReceiveCallbackImpl {
    public:
        JavaProxy(jobject obj);
        virtual void Call(std::string namespace_id, std::string topic_name, int64_t sequence_number, std::vector<uint8_t> contents) override;
