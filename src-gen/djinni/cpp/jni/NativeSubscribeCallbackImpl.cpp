...
void NativeSubscribeCallbackImpl::JavaProxy::JavaProxy::Call(::rocketspeed::djinni::Status c_status, std::string c_namespace_id, std::string c_topic_name, int64_t c_sequence_number, bool c_subscribed) {
    ...
    jniEnv->CallVoidMethod(getGlobalRef(), data.method_Call, j_status.get(), j_namespace_id.get(), j_topic_name.get(), j_sequence_number, j_subscribed);
