...
jobject NativeSubscriptionRequestImpl::toJava(JNIEnv* jniEnv, ::rocketspeed::djinni::SubscriptionRequestImpl c) {
    djinni::LocalRef<jstring> j_namespace_id(jniEnv, ::djinni::HString::toJava(jniEnv, c.namespace_id));
    ...
    jobject r = jniEnv->NewObject(data.clazz.get(), data.jconstructor, j_namespace_id.get(), j_topic_name.get(), j_subscribe, j_start.get());
...
::rocketspeed::djinni::SubscriptionRequestImpl NativeSubscriptionRequestImpl::fromJava(JNIEnv* jniEnv, jobject j) {
    ...
    return ::rocketspeed::djinni::SubscriptionRequestImpl(
        ::djinni::HString::fromJava(jniEnv, djinni::LocalRef<jstring>(jniEnv, static_cast<jstring>(jniEnv->GetObjectField(j, data.field_namespaceId))).get()),
