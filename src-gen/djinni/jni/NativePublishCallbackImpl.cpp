...
void NativePublishCallbackImpl::JavaProxy::JavaProxy::Call(::rocketspeed::djinni::Status c_status, int32_t c_namespace_id, std::string c_topic_name, ::rocketspeed::djinni::MsgIdImpl c_message_id, int64_t c_sequence_number) {
    ...
    jniEnv->CallVoidMethod(getGlobalRef(), data.method_Call, j_status.get(), j_namespace_id, j_topic_name.get(), j_message_id.get(), j_sequence_number);
