...
public:
    ...
    public:
        ...
        virtual void Call(::rocketspeed::djinni::Status status, int16_t namespace_id, std::string topic_name, ::rocketspeed::djinni::MsgIdImpl message_id, int64_t sequence_number, std::vector<uint8_t> contents) override;
