...
#include "HI16.hpp"
#include "HString.hpp"
#include "NativeSubscriptionStartImpl.hpp"
...
jobject NativeSubscriptionRequestImpl::toJava(JNIEnv* jniEnv, ::rocketspeed::djinni::SubscriptionRequestImpl c) {
    ...
    djinni::LocalRef<jobject> j_sequence_number(jniEnv, NativeSubscriptionStartImpl::toJava(jniEnv, c.sequence_number));
...
::rocketspeed::djinni::SubscriptionRequestImpl NativeSubscriptionRequestImpl::fromJava(JNIEnv* jniEnv, jobject j) {
    ...
    return ::rocketspeed::djinni::SubscriptionRequestImpl(
        ...
        NativeSubscriptionStartImpl::fromJava(jniEnv, djinni::LocalRef<jobject>(jniEnv, jniEnv->GetObjectField(j, data.field_sequenceNumber)).get()));
}
