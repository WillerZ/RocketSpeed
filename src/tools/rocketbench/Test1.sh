...
cmd="$BENCHMARK --remote --deploy --start-servers --buffered_storage_max_latency_us=1000 --cockpits=4"
eval $cmd

cmd="$BENCHMARK --messages 250000000 --rate 500000 --max-inflight 7000 --topics 1 --size 100 --progress_period=10000 --cockpits=4 --remote-bench 4 produce"
echo $cmd
eval $cmd

echo Stopping Servers...
cmd="$BENCHMARK --remote --stop-servers --cockpits=4"
eval $cmd
