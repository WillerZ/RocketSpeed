...
cmd="$BENCHMARK --collect-stats --progress_per_line --messages 250000000 --rate 150000 --max-inflight 7000 --topics 10000 --size 100 --remote --deploy --start-servers --stop-servers --progress_period=10000 --buffered_storage_max_latency_us=0 --cockpits=$COCKPITS --towers=$TOWERS --namespaceid_dynamic --remote-bench 4 produce"
echo $cmd
