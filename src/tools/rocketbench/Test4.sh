...
cmd="$BENCHMARK --messages 1 --subscribe-rate 1000000 --rate 150000 --max-inflight 7000 --topics 1 --size 100 --remote --deploy --start-servers --stop-servers --subscription-backlog-distribution=fixed --client-threads=10000 --remote-bench 8 --max_file_descriptors=1000000 --namespaceid_dynamic --towers=1 --cockpits=1 readwrite"
echo $cmd
eval $cmd
